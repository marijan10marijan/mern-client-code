...
export default function Record() {
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      setForm({ name: "", position: "", level: "", gender: "" });
      navigate("/");
    }
  }
  ...
  return (
    <>
      <h3 className="text-lg font-semibold p-4 text-gray-700 uppercase">
              ...
              <div className="mt-2">
                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-slate-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                  <input
                    ...
                    name="name"
                    id="name"
                    className="block flex-1 border-0 bg-transparent py-1.5 pl-2 text-slate-900 placeholder:text-slate-400 outline-transparent sm:text-sm sm:leading-6"
                ...
                <div className="space-y-4 sm:flex sm:items-center sm:space-x-10 sm:space-y-0">
                  <div className="flex items-center">
                    <input
                      ...
                      type="radio"
                      value="Intern"
                      className="h-4 w-4 border-purple-300 accent-purple-600 text-purple-600 focus:ring-purple-600 cursor-pointer"
